...
<body>
	...
	<br>
	<div id="content" class="centered snap features">
		<h1>Upcoming</h1>
		<hr>
		<p>These are the features we'll be releasing very soon in the app. Get ready for even more fun!</p>
		<p>If you want an email notification when it releases, click the button below!</p>
		<a class="button" href="https://docs.google.com/forms/d/e/1FAIpQLSctZyOvDLbh3cUI8Klwi7Nfv_qq0DzziwX74fi3XKt1fsAdTQ/viewform" target="_blank">Notify me!</a>
		<br>
		<h2>Draw Crop</h2>
		<p>Photoshop crop/cut your images, collage, layer, and more! Don't have the time to manually edit yourself into a background? Easily get it done right in the CliqBit app with our new draw crop feature!</p>
		<img class="centeredImg" src="assets/img/drawcrop1.png" alt="Draw Crop Example: Holding on during finals." />
		<img class="centeredImg" src="assets/img/drawcrop2.png" alt="Draw Crop Example: On a mission for Photoshop tools." />
		<img class="centeredImg" src="assets/img/drawcrop3.png" alt="Draw Crop Example: Hunting for the right Photoshop tools" />
		<p>Excited for this new feature? Click the button below to get an email notification when it releases!</p>
		<a class="button" href="https://docs.google.com/forms/d/e/1FAIpQLSctZyOvDLbh3cUI8Klwi7Nfv_qq0DzziwX74fi3XKt1fsAdTQ/viewform" target="_blank">Notify me!</a>
